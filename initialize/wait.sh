...
export APIREADY="/usr/bin/kubectl --kubeconfig /etc/kubernetes/admin.conf get pods -n kube-system -l component=kube-apiserver -o jsonpath='{.items[0].status.containerStatuses[0].ready}'"
